...
class ProjectSvcStub(object):
    ...
    def __init__(self, channel):
        ...
        self.createProject = channel.unary_unary(
                '/project.ProjectSvc/createProject',
...
def add_ProjectSvcServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'project.ProjectSvc', rpc_method_handlers)
...
class ProjectSvc(object):
    ...
    def createProject(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/project.ProjectSvc/createProject',
    ...
    def createTag(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/project.ProjectSvc/createTag',
    ...
    def getProject(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/project.ProjectSvc/getProject',
